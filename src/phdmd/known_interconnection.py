...
# INFORMATION!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# New class CVXPHMethod created which can be used in the standard framework
...
def main():
    ...
    for exp in experiments:
        ...
        logging.info(
            f"H operator is symmetric {np.allclose(H_inf.value,H_inf.value.T)}"
        )
