...
from phdmd.algorithm.methods import CVXABCDPRMethod
    ...
    for exp in experiments:
        ...
        for method in exp.methods:
            if isinstance(method, CVXABCDPRMethod):
                add_method_inputs = {"gillis_options": exp.gillis_options,
        ...
        latex_output = True
        compare_matrices(exp, lti, latex_output=latex_output)
